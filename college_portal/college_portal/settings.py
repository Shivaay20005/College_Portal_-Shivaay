...
# SECRET_KEY = 'django-insecure-0dn6wz!xw85#w*6j^z*a_&$!9$vpb*uq=e4i6!x!ef8mw#+ek2'
...
# #         'BACKEND': 'django.template.backends.django.DjangoTemplates',
# #         'DIRS': [
# #             BASE_DIR / 'templates',  # This includes a global templates folder if you use it
# #         ],
...
#         'APP_DIRS': True,  # This allows looking inside each app's 'templates' directory
#         'OPTIONS': {
#             'context_processors': [
#                 'django.template.context_processors.debug',
#                 'django.template.context_processors.request',
...
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['college-portal.herokuapp.com', '127.0.0.1']
...
CORS_ALLOW_ALL_ORIGINS = True  # Change this to restrict allowed origins in production
